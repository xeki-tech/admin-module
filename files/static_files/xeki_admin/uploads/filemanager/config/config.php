...
$AG_BASE = str_replace('admin/upload/filemanager/dialog.php', '', $scriptName);
$AG_BASE = str_replace('//', '/', $AG_BASE);
$AG_BASE_COMPLETE = $_SERVER['HTTP_HOST'].$AG_BASE;
$AG_BASE_COMPLETE = str_replace('//', '/', $AG_BASE_COMPLETE);
$AG_BASE_COMPLETE = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https://' : 'http://').$AG_BASE_COMPLETE;
...
$config = array(
	...
	*/
	...
	'base_url' => $AG_BASE_COMPLETE.'server_files',
